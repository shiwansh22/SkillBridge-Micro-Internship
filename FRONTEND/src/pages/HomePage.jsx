      ...
      <section className="px-4 py-16 bg-muted">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <FeatureCard
              title="Real Projects"
              description="Work on actual tasks from leading companies and build real-world experience."
            ...
            <FeatureCard
              ...
              description="Get paid fairly for your work and build your professional network."
