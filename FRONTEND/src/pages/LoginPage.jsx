...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // If user object present (even without token) navigate
      const storedUser = user || JSON.parse(localStorage.getItem("user") || "null");
      if (!storedUser) {
        setError("Login succeeded but no user data returned. Check backend response.");
        setLoading(false);
        return;
      }

      if (storedUser.role === "recruiter" || role === "recruiter") {
