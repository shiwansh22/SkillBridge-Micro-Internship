...
public class Task {
    ...
    // NEW: store recruiter-provided Google Form / application link
    ...
    // overload to accept "YYYY-MM-DD" strings from frontend
    public void setDeadline(String deadlineStr) {
        if (deadlineStr == null || deadlineStr.isBlank()) {
            ...
            try {
                ...
                // if parsing fails, keep null (or you can choose to throw)
                this.deadline = null;
            }
        }
    }
